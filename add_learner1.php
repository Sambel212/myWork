<?php
   ...
   session_start();
    ...
    $select = $pdo->prepare("SELECT id FROM student_tb");
    $select->execute();
    ...
    if(isset($_POST['add_record'])){
      ...
      // }
      $admission_number = "RC".mt_srand(7);
      $state = $_POST['state'];
      $lga = $_POST['lga'];
      $pob = $_POST['pob'];
...
$insert = $pdo->prepare("INSERT INTO student_tb (firstname, surname, admission_number, password, gender, classs, dob, blood_grp, yr_admission, state, lga, birth_place, mother_name, mother_phone, father_name, father_phone, Address, img, left_student) values 
  (:firstname, :surname, :admission_number, :password, :gender, :classs, :dob, :blood_grp, :yr_admission, :state, :lga, :birth_place, :mother_name, :mother_phone, :father_name, :father_phone, :address, :img, 0)");  
                    ...
                    $insert->bindParam(':classs', $classs);
              ...
              <form action="" method="POST" name="form_product" enctype="multipart/form-data" autocomplete="off">
                <div class="card-body">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="exampleSelectBorderWidth2">Year of Admission</label>
                          <select class="role custom-select form-control-border border-width-2" id="exampleSelectBorderWidth2" name="admission_year" required>
                          <?php
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter Place of Birth" name="subjects" required>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                          <label for="exampleInputPassword1">Address</label>
                          <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Home Address" name="qualification" required>
                        </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Father's Name" name="father_name" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Father's Phone</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Father's Phone" name="father_phone" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Mother's Phone" name="mother_name" required>
                      </div>
                    </div>
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="exampleInputPassword1">Mother's Phone</label>
                        <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Mother's Phone" name="mother_phone" required>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="exampleInputFile">Add Student Image</label>
                        <div class="input-group">
